...
def main():
    margin_percentage = 100  # Set the margin percentage to 30%
    ...
    for recipe_name, recipe_items in recipes.items():
        ...
        # Calculate the selling price with a 30% margin
        selling_price = total_cost * (1 + margin_percentage / 100)
        print(f'Total cost for {recipe_name}: INR:{total_cost:.2f}')
        print(f'Selling price for {recipe_name} with a {margin_percentage}% margin: INR:{selling_price:.2f}')
